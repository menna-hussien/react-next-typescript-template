...
# Set version number
$version = (Get-Content [PROJECT_NAME_PLACEHOLDER]/package.json) -join "`n" | ConvertFrom-Json | Select-Object -ExpandProperty "version-preprod"
Write-Output "##vso[task.setvariable variable=moaeen.tag.name]$destination.v.$version"
